...
private final Joystick operatorOne = new Joystick(0);
    ...
    SmartDashboard.putData("driveFlip", new driveFlip( m_drive ));
...
final JoystickButton btnFlipDrive = new JoystickButton(operatorOne, 2);        
btnFlipDrive.whenPressed(new driveFlip( m_drive ) ,true);
    SmartDashboard.putData("btnFlipDrive",new driveFlip( m_drive ) );

final JoystickButton btnDriverCamera = new JoystickButton(operatorOne, 10);        
