...
private final Joystick operatorOne = new Joystick(0);
    ...
    private void configureButtonBindings() {
        ...
        final JoystickButton btnSafty = new JoystickButton(xboxController1, 6);        
...
btnShootTarmac.whileHeld(new shootRPMS(3200, m_ballShooter) ,true);
    SmartDashboard.putData("btnShootTarmac",new shootRPMS(3200, m_ballShooter) );
...
final JoystickButton btnGearShift = new JoystickButton(xboxController1, 4);        
