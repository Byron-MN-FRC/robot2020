...
final JoystickButton btnHardStopTest = new JoystickButton(operatorTwo, 8);        
btnHardStopTest.whenPressed(new ClimbHardStop( m_climb ) ,true);
...
final JoystickButton btnEnableClimb = new JoystickButton(operatorTwo, 7);        
btnEnableClimb.whileHeld(new enableClimb(m_climb) ,true);
