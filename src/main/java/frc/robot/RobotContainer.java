...
private final Joystick operatorOne = new Joystick(0);
    ...
    SmartDashboard.putData("runIndexer", new runIndexer( m_ballIndexer ));
    ...
    private void configureButtonBindings() {
        final JoystickButton btnFlipo = new JoystickButton(operatorOne, 2);
        btnFlipo.whenPressed(new flipo( m_drive ) ,true);
        // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=BUTTONS
// Create some buttons

final JoystickButton btnIndexer = new JoystickButton(operatorTwo, 8);        
btnIndexer.whenPressed(new runIndexer( m_ballIndexer ) ,true);
    SmartDashboard.putData("btnIndexer",new runIndexer( m_ballIndexer ) );
