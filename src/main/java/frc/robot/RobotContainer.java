...
private final Joystick operatorOne = new Joystick(0);
    ...
    m_chooser.addOption("1", new AutoBlueLeft( m_ballAcquisition, m_ballIndexer, m_ballShooter, m_drive ));
    m_chooser.addOption("AutoBlueRight", new AutoBlueRight( m_ballAcquisition, m_ballIndexer, m_ballShooter, m_drive));
    m_chooser.addOption("2", new AutoRedLeft( m_ballAcquisition, m_ballIndexer, m_ballShooter, m_drive ));
    m_chooser.addOption("3", new AutoRedRight( m_ballAcquisition, m_ballIndexer, m_ballShooter, m_drive ));
