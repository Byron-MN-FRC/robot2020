...
private final Joystick operatorOne = new Joystick(0);
  ...
  */
  private RobotContainer() {
    ...
    SmartDashboard.putData("dummyOne", new dummyOne( m_drive ));
    SmartDashboard.putData("dummyTwo", new dummyTwo( m_drive ));
    SmartDashboard.putData("reverseAcquire", new reverseAcquire( m_drive ));
    SmartDashboard.putData("acquire", new acquire( m_drive ));
    SmartDashboard.putData("retractAcquisition", new retractAcquisition());
    SmartDashboard.putData("deployAcquisition", new deployAcquisition());
    SmartDashboard.putData("enableClimb", new enableClimb());
    SmartDashboard.putData("shoot", new shoot());
    SmartDashboard.putData("enableLimelight", new enableLimelight());
    SmartDashboard.putData("manualMagazineDown", new manualMagazineDown());
    SmartDashboard.putData("manualMagazineUp", new manualMagazineUp());
...
btnMagazineUp.whenPressed(new manualMagazineUp() ,true);
...
btnMagazineDown.whenPressed(new manualMagazineDown() ,true);
...
btnEnableLimelight.whenPressed(new enableLimelight() ,true);
    SmartDashboard.putData("btnEnableLimelight",new enableLimelight() );

final JoystickButton btnShoot = new JoystickButton(operatorTwo, 1);        
btnShoot.whenPressed(new shoot() ,true);
...
btnAcquire.whenPressed(new acquire( m_drive ) ,true);
...
btnReverseAcquire.whenPressed(new reverseAcquire( m_drive ) ,true);
...
btnFindBall.whenPressed(new alexaFindBall( m_drive ) ,true);
